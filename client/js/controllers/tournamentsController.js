...
myApp.controller('tournamentsController',function($scope,$routeParams,draftFactory,playerFactory){
	...
	$(document).on('ready', function() {
				...
				var knownBrackets = [2,4,8,16,32], // brackets with "perfect" proportions (full fields, no byes)
					...
					exampleTeams  = _.shuffle(["Liverpool","Atlético Madrid","Napoli","Bor. Dortmund",
						"Chelsea","Spurs","Lazio","Manchester City",
						"Manchester United","Feyenoord","Zenit","AS Monaco",
						"FC Bayern","Chievo Verona","FC Porto","Sivasspor",
						"Stoke City","Swansea City","Real Sociedad",myTeam,
						"SL Benfica","Arsenal","FC Shakhtar","Valencia CF",
						"Juventus","Roma","PSG","Real Madrid",
						"Milan","FC Barcelona","Ajax","Inter",]),
